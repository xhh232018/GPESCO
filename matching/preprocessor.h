...
private:
    ...
    void scan_relation(catalog* storage,uint32_t src,uint32_t dst);
...
public:
    ...
    void execute(const Graph *query_graph, const Graph *data_graph, catalog *storage, bool enable_elimination, uint32_t src ,uint32_t dst);
