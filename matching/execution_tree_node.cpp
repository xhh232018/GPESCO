...
void no_partition_hash_join_node::execute_operator_nc(std::vector<flat_relation *> &relations) {
    output_count_ = nop_join_->execute();
    relations[OUTPUT_RELATION_ID(id_)] = output_;
}

void no_partition_hash_join_node::execute_operator_je(std::vector<flat_relation *> &relations) {
    output_count_ = nop_join_->execute();
    relations[OUTPUT_RELATION_ID(id_)] = output_;
}

void no_partition_hash_join_node::execute_operator_lae(std::vector<flat_relation *> &relations) {
    output_count_ = nop_join_->execute();
    relations[OUTPUT_RELATION_ID(id_)] = output_;
}

void no_partition_hash_join_node::execute_operator_probe_mat(std::vector<flat_relation *> &relations) {
    output_count_ = nop_join_->execute();
    relations[OUTPUT_RELATION_ID(id_)] = output_;
}

void no_partition_hash_join_node::execute_operator_pe(std::vector<flat_relation *> &relations) {
    output_count_ = nop_join_->execute();
    relations[OUTPUT_RELATION_ID(id_)] = output_;
}

void no_partition_hash_join_node::execute_operator_iee(std::vector<flat_relation *> &relations) {
    output_count_ = nop_join_->execute();
    relations[OUTPUT_RELATION_ID(id_)] = output_;
}

void no_partition_hash_join_node::execute_operator_rwc(std::vector<flat_relation *> &relations) {
    output_count_ = nop_join_->execute();
    relations[OUTPUT_RELATION_ID(id_)] = output_;
}

void no_partition_hash_join_node::execute_operator_rwch(std::vector<flat_relation *> &relations) {
    output_count_ = nop_join_->execute();
    relations[OUTPUT_RELATION_ID(id_)] = output_;
}

void no_partition_hash_join_node::execute_operator_rwd(std::vector<flat_relation *> &relations) {
    output_count_ = nop_join_->execute();
    relations[OUTPUT_RELATION_ID(id_)] = output_;
}

void no_partition_hash_join_node::execute_operator_rwdw_epl(std::vector<flat_relation *> &relations) {
    output_count_ = nop_join_->execute();
    relations[OUTPUT_RELATION_ID(id_)] = output_;
}

void no_partition_hash_join_node::execute_operator_rwdw_final(std::vector<flat_relation *> &relations) {
    output_count_ = nop_join_->execute();
    relations[OUTPUT_RELATION_ID(id_)] = output_;
}
...
void leap_frog_trie_join_node::execute_operator_nc(std::vector<flat_relation *> &relations) {
    output_count_ = lftj_->execute();
    relations[OUTPUT_RELATION_ID(id_)] = output_relation_;
}

void leap_frog_trie_join_node::execute_operator_je(std::vector<flat_relation *> &relations) {
    output_count_ = lftj_->execute_je();
    relations[OUTPUT_RELATION_ID(id_)] = output_relation_;
}

void leap_frog_trie_join_node::execute_operator_lae(std::vector<flat_relation *> &relations) {
    output_count_ = lftj_->execute_lae();
    relations[OUTPUT_RELATION_ID(id_)] = output_relation_;
}

void leap_frog_trie_join_node::execute_operator_probe_mat(std::vector<flat_relation *> &relations) {
    output_count_ = lftj_->execute_mat_probe();
    relations[OUTPUT_RELATION_ID(id_)] = output_relation_;
}

void leap_frog_trie_join_node::execute_operator_pe(std::vector<flat_relation *> &relations) {
    output_count_ = lftj_->execute_pe();
    relations[OUTPUT_RELATION_ID(id_)] = output_relation_;
}

void leap_frog_trie_join_node::execute_operator_iee(std::vector<flat_relation *> &relations) {
    output_count_ = lftj_->execute_iee();
    relations[OUTPUT_RELATION_ID(id_)] = output_relation_;
}

void leap_frog_trie_join_node::execute_operator_rwc(std::vector<flat_relation *> &relations) {
    output_count_ = lftj_->execute_rwc();
    relations[OUTPUT_RELATION_ID(id_)] = output_relation_;
}

void leap_frog_trie_join_node::execute_operator_rwch(std::vector<flat_relation *> &relations) {
    output_count_ = lftj_->execute_rwch();
    relations[OUTPUT_RELATION_ID(id_)] = output_relation_;
}

void leap_frog_trie_join_node::execute_operator_rwd(std::vector<flat_relation *> &relations) {
    output_count_ = lftj_->execute_rwd();
    relations[OUTPUT_RELATION_ID(id_)] = output_relation_;
}

void leap_frog_trie_join_node::execute_operator_rwdw_epl(std::vector<flat_relation *> &relations) {
    output_count_ = lftj_->execute_rwdw_epl();
    relations[OUTPUT_RELATION_ID(id_)] = output_relation_;
}

void leap_frog_trie_join_node::execute_operator_rwdw_final(std::vector<flat_relation *> &relations) {
    output_count_ = lftj_->execute_rwdw_final();
    relations[OUTPUT_RELATION_ID(id_)] = output_relation_;
}
