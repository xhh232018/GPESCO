...
public:
    ...
    uint64_t execute_nc(catalog& catalog, uint64_t output_count_limit);

    uint64_t execute_je(catalog& catalog, uint64_t output_count_limit);

    uint64_t execute_lae(catalog& catalog, uint64_t output_count_limit);

    uint64_t execute_probe_mat(catalog& catalog, uint64_t output_count_limit);

    uint64_t execute_pe(catalog& catalog, uint64_t output_count_limit);

    uint64_t execute_iee(catalog& catalog, uint64_t output_count_limit);

    uint64_t execute_rwc(catalog& catalog, uint64_t output_count_limit);

    uint64_t execute_rwch(catalog& catalog, uint64_t output_count_limit);

    uint64_t execute_rwd(catalog& catalog, uint64_t output_count_limit);

    uint64_t execute_rwdw_epl(catalog& catalog, uint64_t output_count_limit);

    uint64_t execute_rwdw_final(catalog& catalog, uint64_t output_count_limit);
